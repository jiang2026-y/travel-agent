...
面向企业差旅场景的多智能体大模型应用：从"我要申请 9 月 18 日从北京去杭州出差"这样的自然语言出发，完成**差旅申请与审批、机票/火车/酒店查询与预订、差旅政策与知识问答、签证/天气/目的地资讯**等全流程动作，并保证写操作可控、过程可见、失败可降级。

本项目参照既有 Java 参考实现，按 Python 技术栈重写并扩展，服务端 130 个源码文件约 2.08 万行，测试 75 个文件约 8 千行。
